...
export type AppDTO = { id: string; name: string; icon: string; description: string; category?: string; source?: string; status: "running" | "stopped" | "installing" | "error"; version?: string; url?: string; updateAvailable: boolean; installed: boolean; installable?: boolean }
